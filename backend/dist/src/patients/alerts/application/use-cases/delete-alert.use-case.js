...
exports.DeleteAlertUseCase = void 0;
...
let DeleteAlertUseCase = class DeleteAlertUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(alertId) {
        ...
        if (!alert) {
            throw new alert_not_found_error_1.AlertNotFoundError(alertId);
        }
        await this.repo.delete(alertId);
    }
};
exports.DeleteAlertUseCase = DeleteAlertUseCase;
exports.DeleteAlertUseCase = DeleteAlertUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(alertRepositoryInterface.ALERT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], DeleteAlertUseCase);
//# sourceMappingURL=delete-alert.use-case.js.map